...
def recommend_scibert(args):
    ...
    user_query_encoded = tokenizer.encode(args.user_query ,return_tensors='tf',max_length=768, pad_to_max_length=False)
    print()
